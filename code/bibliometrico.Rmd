...
Although, the citation is not a scientific tool to assess the publication, it is a valuable metric that recognizes research parameters [27]. The citation index, as a type of bibliometric method, shows the number of times an article has been used by other papers [28]. Hence, citation analysis helps researchers to obtain a prelimi- nary idea about the articles and research that has an impact in a particular field of inter- est and it deals with the examination of the documents cited by scholarly works [29, 30].


**(SOBRE BIBLIOMETRIA y este interés en ciencias sociales)**

In the following section we review these papers and summarize their findings regarding the 3 areas of interest mentioned, ............ COMO CONTEXTO PARA ENTENDER LO QUE PASA EN CIENCIAS SOCIALES


figure 3 illustrates the sampled articles
by academic domain. It is found that a significant portion of the sample is attributed to two domains, i.e. Computer Science and Engineering, with 29.6 and 19 percent, respectively. This information echoes the finding discovered by Kalantari et al. (2017), in which Computer Science, Engineering, Telecommunications, Operations Research Management Science and Medical Informatics are recognized as the five most popular areas in academia. In addition, Figure 3 also shows that the usage of big data is not only in the field of natural science, such as Computer Science, Engineering, Mathematics and others, but also social science, i.e. Business, Management and Accounting domains 
...
ciencias sociales para repensar lo etico / critico?

xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx

**In this work we draw heavily on the excellent work by Ahmad et. al (2020)**
...
will provide context for comparisson between science literature and social sciences (included)

**(RQ)**

ALGO ASI? The main objective of choosing the research questions is to identify the top cited papers, the contributions of various countries in advancing big data research, and identification of key research areas. The set of research questions are as following
